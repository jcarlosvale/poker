package com.poker.importer.util;
...
import static com.poker.importer.util.CardUtil.valueOf;
import static com.poker.importer.util.Chen.calculateChenFormulaFrom;
...
public class CardsGenerator {
    ...
    private static Cards generateCard(String rawCard) {
        ...
        return Cards
                ...
                .suited(isSuited)
                .pair(isPair)
                .chen(calculateChenFormulaFrom(normalised))
